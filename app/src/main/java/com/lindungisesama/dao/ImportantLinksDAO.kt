...
interface ImportantLinksDAO {

	@GET("/{prismic_api_version}/{prismic_document}")
	fun getImportantLinks(
		...
		@Query(PRISMIC_PARAM_QUERY) query: String = generateQueryByType(PrismicTypes.IMPORTANT_LINKS.name.toLowerCase()),
