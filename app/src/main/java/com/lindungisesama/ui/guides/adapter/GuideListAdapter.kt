package com.lindungisesama.ui.guides.adapter
...
import kotlinx.android.synthetic.main.item_list_guides.view.*

class GuideListAdapter(
	private val context: Context,
	private val guidesItemClickListener: GuidesItemClickListener
) : RecyclerView.Adapter<GuideListAdapter.ViewHolder>() {
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder =
		ViewHolder(LayoutInflater.from(context).inflate(R.layout.item_list_guides, parent, false))
		...
		fun bind(result: Result) {
			result.data?.let { data ->
				...
				itemView.button_read_more.setOnClickListener {
					guidesItemClickListener.onGuidesItemClick(result)
				}
			}
		}
	}
